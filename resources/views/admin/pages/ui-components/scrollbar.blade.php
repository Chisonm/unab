...
.perfect-scrollbar-example {
  ...
  max-height: 250px;	
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#Default2"><i data-feather="copy"></i></button>
    </figure>
...
var scrollbarExample = new PerfectScrollbar('.perfect-scrollbar-example');</script></code></pre>
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#Default3"><i data-feather="copy"></i></button>
    </figure>
