...
<div class="row">
  <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
    ...
    <p class="lead">List groups are a flexible and powerful component for displaying a series of content. Read the <a href="https://getbootstrap.com/docs/4.3/components/list-group/" target="_blank">Official Bootstrap Documentation</a> for a full list of instructions and other options.</p>
    <hr>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="list-group">
  ...
  <li class="list-group-item">Vestibulum at eros</li>
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#activeItems"><i data-feather="copy"></i></button>
    </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="list-group">
  ...
  <li class="list-group-item">Vestibulum at eros</li>
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#disabledItems"><i data-feather="copy"></i></button>
    </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="list-group">
  ...
  <a href="#" class="list-group-item list-group-item-action disabled" tabindex="-1" aria-disabled="true">Vestibulum at eros</a>
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#linksButtons"><i data-feather="copy"></i></button>
    </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><ul class="list-group list-group-flush">
  ...
  <li class="list-group-item">Vestibulum at eros</li>
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#Flush"><i data-feather="copy"></i></button>
    </figure>
