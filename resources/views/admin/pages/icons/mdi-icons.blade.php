  ...
  <div class="col-md-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-description">Visit the <a href="https://materialdesignicons.com/" target="_blank"> Official Material Design Icons Documentation </a>.</p>                
        <p class="card-description">Usage example : &lt;i class="mdi mdi-star"&gt;&lt;/i&gt;</p>
        <div class="container">
