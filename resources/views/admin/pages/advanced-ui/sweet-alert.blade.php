  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-description mb-0">Read the <a href="https://sweetalert2.github.io/" target="_blank"> Official SweetAlert2 Documentation </a>for a full list of instructions and other options.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-4 grid-margin stretch-card">
    <div class="card">
      <div class="card-body d-flex flex-column align-items-center">
        <p class="card-description text-center">passing a parameter, you can execute something else for "Cancel"</p>
...
@push('plugin-scripts')
  ...
  {!! Html::script('/assets/plugins/promise-polyfill/polyfill.min.js') !!}
@endpush
